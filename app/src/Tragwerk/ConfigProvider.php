...
use Tragwerk\Factory\Handler\Configuration\ServiceStatusHandlerFactory;
        ...
        return [
            'dependencies' => [
                'factories'          => [
                    ...
                    Application\Handler\Configuration\ServiceStatusHandler::class => ServiceStatusHandlerFactory::class,
    ...
    public function getEvents(): array
    {
        return [
            ...
            'events'       => [
                ...
                Event\EmailChanged::class => [EventListener\User\UpdateUserEmail::class],
                ...
                Event\EnvVarCreated::class => [
                    EventListener\EnvVar\PersistEnvVar::class,
                    EventListener\EnvVar\TriggerBuildOnEnvVarChange::class,
                ],
                Event\EnvVarUpdated::class => [
                    EventListener\EnvVar\UpdateEnvVar::class,
                    EventListener\EnvVar\TriggerBuildOnEnvVarChange::class,
                ],
                Event\EnvVarDeleted::class => [
                    EventListener\EnvVar\DeleteEnvVar::class,
                    EventListener\EnvVar\TriggerBuildOnEnvVarChange::class,
                ],
